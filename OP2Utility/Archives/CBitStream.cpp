...
CBitStream::CBitStream(int bufferSize, char *buffer)
{
	// Initialize class variables
...
bool CBitStream::EndOfStream() const
{
	return m_ReadBitIndex >= m_BufferBitSize;
}

int CBitStream::GetBitReadPos() const
{
