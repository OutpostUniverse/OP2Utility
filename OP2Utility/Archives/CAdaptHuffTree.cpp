...
CAdaptHuffTree::CAdaptHuffTree(unsigned short numTerminalNodes)
{
	unsigned short i;
	unsigned short left;
...
unsigned short CAdaptHuffTree::GetRootNodeIndex()
{
...
unsigned short CAdaptHuffTree::GetChildNode(unsigned short nodeIndex, bool bRight)
{
...
bool CAdaptHuffTree::IsLeaf(unsigned short nodeIndex)
{
	// Check that the nodeIndex is in range
	if (nodeIndex >= m_NumNodes)
	{
...
unsigned short CAdaptHuffTree::GetNodeData(unsigned short nodeIndex)
{
	// Check that the nodeIndex is in range
	if (nodeIndex >= m_NumNodes)
	{
...
void CAdaptHuffTree::UpdateCodeCount(unsigned short code)
{
	int curNodeIndex;
...
void CAdaptHuffTree::SwapNodes(unsigned short node1, unsigned short node2)
{
	unsigned short temp;
...
int CAdaptHuffTree::GetEncodedBitString(int code, int &bitString)
{
	int curNodeIndex;
	int numBits;
	bool bBit;
